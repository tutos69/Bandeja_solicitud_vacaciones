...
import { sampleWithRequiredData } from '../vacation-request.test-samples';
...
describe('VacationRequest Management Component', () => {
  ...
  it('should call load all on init', () => {
    ...
    expect(comp.vacationRequests()[0]).toEqual(expect.objectContaining({ id: 10483 }));
  });

  describe('trackId', () => {
    it('should forward to vacationRequestService', () => {
      const entity = { id: 10483 };
      jest.spyOn(service, 'getVacationRequestIdentifier');
      const id = comp.trackId(entity);
      expect(service.getVacationRequestIdentifier).toHaveBeenCalledWith(entity);
